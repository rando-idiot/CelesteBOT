...
const characters = {};
const characterFiles = fs.readdirSync(`./characters`);
...
for (const characterFile of characterFiles) {
    ...
    const characterJSON = fs.readFileSync(`./characters/${characterFile}`).toString("utf-8");
    let characterObject = {};
    ...
    characterCheck: {
        ...
        for (const portrait of characterObject.portraits) {
            ...
            try { fs.readFileSync(`./assets/portraits/${character}/${portrait}.png`) } catch {
    ...
    try { fs.readFileSync(`./assets/textboxes/${characterObject.textbox}.png`) } catch {
